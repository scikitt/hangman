const leaderboard = async (page = 1, per_page = 10) => {
    const response = await fetch(`https://hangman-id.ue.r.appspot.com/leaderboard?page=${page}&per_page=${per_page}`, {
        method: "GET",
        headers: {
...
const userRanking = async () => {
    ...
    const response = await fetch(`https://hangman-id.ue.r.appspot.com/user-ranking/${currentUser}`, {
        method: "GET",
